...
\begin{itemize}
\item Advanced math: \texttt{amsmath}
\item Fixes, tools for \texttt{amsmath}: \texttt{mathtools}
\item Options within packages (eg. \texttt{\usepackage[intlimits]{amsmath}})
\item Envirnments within packages (eg. \texttt{\begin{displaymath} or \begin{equation}})
...
\item Intense math guide \url{ftp://ftp.ams.org/pub/tex/doc/amsmath/short-math-guide.pdf}
\end{itemize}
